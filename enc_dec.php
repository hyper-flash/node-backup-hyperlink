...
<head>
    ...
    <title>Welcome to TrainingSession App </title>
...
<div id="container">
    <h1>Encryption & Decryption TrainingSession </h1>

    <div id="body">
        <form class='form-horizontal' role='form' id = 'poster_add' name= 'poster_add' enctype='multipart/form-data' action="index.php" method="POST">
...
$secret = hash('sha256', '4tHPsPeNlzAxgJrdN1jLbFMSSl5bFzzg');
$iv = '4tHPsPeNlzAxgJrd';
